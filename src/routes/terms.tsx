...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms of Service — ELARAWAVE" }, { name: "description", content: "ELARAWAVE terms of service." }] }),
  component: Terms,
});
  ...
  return (
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-text-muted space-y-4">
        <p>By ordering from ELARAWAVE you agree to these terms. Water is delivered fresh; empties are collected on the next visit. Prices, coverage, and offers may change without prior notice.</p>
